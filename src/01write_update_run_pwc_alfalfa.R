...
###########update parameter##########################################################################
 ...
 ######################USLEC##########################################################################################
 Num=22#Number of crop periods that follow
 ...
 Num=2#Number of crop periods that follow
...
bd3_list <- c(unlist(strsplit(a[71],",")),"")#adding extra empty value at end
 ...
 a[135]=paste(PLVKRT_list,collapse=",")
 ####################PLDKRT############################################
