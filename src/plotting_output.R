...
#q$newdate <- with(q, as.POSIXct(y, format="%y-%d-%m"))
...
# par(oma = c(1, 1, 1, 1))
options(scipen=999)
plot(diazinon_con$Date,diazinon_con$pool.high,log="y",type='l',lty=2,col = "red",xlab="Year", ylab="Diazinon Concentration (ug/l)",bty = "n",ylim=c(0.001,10))#,,yaxt = "n",ylim=c(0.001,0.9)
